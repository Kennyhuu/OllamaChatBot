...
@Service
public class DiscordMessageCreateListener extends MessageListener implements EventListener<MessageCreateEvent> {
     ...
     *
     * @param ollamaSpringChatService The ChatService to be used for message processing
     */
    @Autowired
    public DiscordMessageCreateListener(OllamaSpringChatService ollamaSpringChatService) {
    ...
    public Mono<Void> execute(MessageCreateEvent event) {
        ...
        return processCommand(event.getMessage(), ollamaSpringChatService);
    }
}
